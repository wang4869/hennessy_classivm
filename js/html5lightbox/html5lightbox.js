...
function loadHtml5LightBox(jsFolder) { (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            inst.options = $.extend({
                ...
                showplaybutton: true,
                playimage: "playBtn.png",
                pauseimage: "lightbox-pause.png",
                fullscreenmode: true,
                fullscreencloseimage: "btnClose.png",
                fullscreennextimage: "btnNext.png",
            ...
            inst.createMarkup = function() {
                ...
                if (inst.options.navarrowsalwaysshowontouch || inst.options.alwaysshownavarrows) {
                    styleCss += "#html5box-html5-lightbox .html5-prev-touch { position:fixed;left:0px;top:50%;margin-top:-16px;margin-left:-32px;} #html5box-html5-lightbox .html5-next-touch { position:fixed;right:0px;top:50%;margin-top:-16px;margin-right:-32px;}";
                ...
                if (inst.options.titlestyle == "right") {
                    styleCss += "#html5box-html5-lightbox #html5-elem-wrap {width:" + inst.options.imagepercentage + "%;height:100%;} #html5box-html5-lightbox #html5-elem-data-box {min-height:100%; padding:0;}";
                    styleCss += "@media (max-width: " + inst.options.sidetobottomscreenwidth + "px) {#html5box-html5-lightbox #html5-elem-wrap {width:100%;height:auto;} #html5box-html5-lightbox #html5-elem-data-box {width:100%;height:auto;min-height:0; padding:0;}}"
                } else if (inst.options.titlestyle == "left") {
                    styleCss += "#html5box-html5-lightbox #html5-elem-wrap {height:100%;} #html5box-html5-lightbox #html5-elem-data-box {width:" + String(100 - inst.options.imagepercentage) + "%;min-height:100%; padding:0;}";
                    styleCss += "@media (max-width: " + inst.options.sidetobottomscreenwidth + "px) {#html5box-html5-lightbox #html5-elem-wrap {width:100%;height:auto;} #html5box-html5-lightbox #html5-elem-data-box {width:100%;height:auto;min-height:0; padding:0;}}"
                }
                ...
                var elemText = "<div id='html5-elem-data-box' style='display:none;box-sizing:border-box; padding:0;'><div id='html5-text' style='display:none;overflow:hidden;'></div></div>";
                ...
                if (inst.options.fullscreenmode) {
					...
					$("#html5-next,#html5-prev").css('position','fixed');
				...
				$("#html5-elem-data-box").css('padding','0');
                ...
                inst.$watermark = $("#hidde-html5-watermark", inst.$lightbox);//#html5-watermark
            ...
            inst.calcBoxPosition = function(initW, initH) {
                var boxW = initW + 2 * inst.options.bordersize-40;
                var boxH = initH + 2 * inst.options.bordersize-30;
                var winH = window.innerHeight ? window.innerHeight: $(window).height();
            ...
            inst.embedHTML5Video = function($container, src, autoplay, loopvideo) {
				...
				$('#html5-lightbox-video').height('100%');
            };
            ...
            inst.checkType = function(href) {
				...
				if (href.match(/\:\/\/.*(youku)/i)) return 12;
                return 7
            };
